...
/* .C calls */
extern void odin_model_asb_initmod_desolve(void *);
extern void odin_model_asb_output_dde(void *);
extern void odin_model_asb_rhs_dde(void *);
extern void odin_model_asb_rhs_desolve(void *);
...
/* .Call calls */
extern SEXP odin_model_asb_contents(SEXP);
extern SEXP odin_model_asb_create(SEXP);
extern SEXP odin_model_asb_initial_conditions(SEXP, SEXP);
extern SEXP odin_model_asb_metadata(SEXP);
extern SEXP odin_model_asb_rhs_r(SEXP, SEXP, SEXP);
extern SEXP odin_model_asb_set_initial(SEXP, SEXP, SEXP, SEXP);
extern SEXP odin_model_asb_set_user(SEXP, SEXP);
...
static const R_CMethodDef CEntries[] = {
    {"odin_model_asb_initmod_desolve",            (DL_FUNC) &odin_model_asb_initmod_desolve,            1},
    {"odin_model_asb_output_dde",                 (DL_FUNC) &odin_model_asb_output_dde,                 1},
    {"odin_model_asb_rhs_dde",                    (DL_FUNC) &odin_model_asb_rhs_dde,                    1},
    {"odin_model_asb_rhs_desolve",                (DL_FUNC) &odin_model_asb_rhs_desolve,                1},
...
static const R_CallMethodDef CallEntries[] = {
    {"odin_model_asb_contents",                      (DL_FUNC) &odin_model_asb_contents,                      1},
    {"odin_model_asb_create",                        (DL_FUNC) &odin_model_asb_create,                        1},
    {"odin_model_asb_initial_conditions",            (DL_FUNC) &odin_model_asb_initial_conditions,            2},
    {"odin_model_asb_metadata",                      (DL_FUNC) &odin_model_asb_metadata,                      1},
    {"odin_model_asb_rhs_r",                         (DL_FUNC) &odin_model_asb_rhs_r,                         3},
    {"odin_model_asb_set_initial",                   (DL_FUNC) &odin_model_asb_set_initial,                   4},
    {"odin_model_asb_set_user",                      (DL_FUNC) &odin_model_asb_set_user,                      2},
