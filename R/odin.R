...
odin_model_asb_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_asb_rhs_dde",
      rhs_desolve = "odin_model_asb_rhs_desolve",
      initmod_desolve = "odin_model_asb_initmod_desolve",
      output_dde = "odin_model_asb_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "asb_coverage", "asb_off", "asb_on", "b0",
             "b1", "betaL", "bites_Bed", "bites_Indoors", "cD", "chi", "cT",
             "cU", "d_IRS0", "d_ITN0", "d1", "dB", "dCA", "dCM", "dE", "dEL",
             "delayGam", "delayMos", "den", "dID", "dLL", "dPL", "eta",
             "fD0", "feeding_rate", "foi_age", "ft", "gamma1", "gammaD",
             ...
             "kB", "kC", "kD", "mu_asb", "mu0", "muEL", "muLL", "muPL",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_asb_rhs_dde", package = "ICDMM")
        .C("odin_model_asb_rhs_desolve", package = "ICDMM")
        .C("odin_model_asb_initmod_desolve", package = "ICDMM")
        .C("odin_model_asb_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_asb_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_asb_metadata", private$ptr,
                    PACKAGE = "ICDMM")
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("odin_model_asb_create", user, PACKAGE = "ICDMM")
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_asb.json", mustWork = TRUE,
                             package = "ICDMM")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("odin_model_asb_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_asb_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_asb_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_asb_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_asb <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_asb")
  odin_model_asb_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_asb) <- "odin_generator"
attr(odin_model_asb, "generator") <- odin_model_asb_
