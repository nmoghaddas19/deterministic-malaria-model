...
odin_model_asb_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "asb_off", "asb_on", "b0", "b1", "betaL",
             "bites_Bed", "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0",
             "d_ITN0", "d1", "dB", "dCA", "dCM", "dE", "dEL", "delayGam",
             "delayMos", "den", "dID", "dLL", "dPL", "eta", "fD0",
             "feeding_rate", "foi_age", "ft", "gamma1", "gammaD", "gammaL",
